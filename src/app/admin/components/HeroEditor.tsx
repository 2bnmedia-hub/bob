    ...
    <div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
        ...
        <div>
          ...
          <input value={(slide as any).btnHref || "/"} onChange={e => update("btnHref", e.target.value)} placeholder="/category/tools או https://..." style={{ width: "100%", border: "1px solid #ddd", borderRadius: 8, padding: "8px 12px", fontSize: 14, fontFamily: "inherit", outline: "none", boxSizing: "border-box" }} />
        </div>
